...
class HomePage_2 extends StatefulWidget {
  ...
  @override
  _HomePageState_2 createState() => _HomePageState_2();
}

class _HomePageState_2 extends State<HomePage_2> {
  double? myValue;
  String? loLoo;
  final List<Color> pageColors = [HexColor('#3374BB'), HexColor('#0E285C')];
  ...
  Widget build(BuildContext context) {
    final slider = SleekCircularSlider(
        appearance: CircularSliderAppearance(
          customWidths:
          CustomSliderWidths(trackWidth: 15, progressBarWidth: 10, shadowWidth: 15, handlerSize: 6),
          customColors:
          CustomSliderColors(
              dotColor: HexColor('#73F5FD'),
              trackColor: HexColor('#123152'),
              progressBarColors: [HexColor('#4CA5F2'), HexColor('#6EEBF9')],
              ...
              child : SizedBox(
                  ...
                  child: FittedBox(
                      child: FloatingActionButton(
                        ...
                        child: Icon(Icons.play_arrow, size: 40, color: HexColor("#C3C9BB")),
                      )
                  )
              )
          );
